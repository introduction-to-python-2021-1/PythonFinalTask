...
from reader_core.reader import Reader
from reader_core.rss_classes import RSSItem
...
class XMLParser(Parser):
    ...
    def parse_news(self, link: str, news_limit: int = None, show_logs: bool = False):
        ...
        try:
            ...
            if len(link) == 0:
                raise ValueError(
                    f"(XMLParser.parse_news) Illegal value for 'link': {str(link)}. It mast be not empty str ")
