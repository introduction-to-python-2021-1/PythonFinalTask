...
class TestJsonToJsonConverter(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.json_2 = {
            ...
            "Links": {
                ...
                "https://img.buzzfeed.com/buzzfeed-static/static/2021-04/25/23/campaign_images/03f6839c6b5d/twitter-"
                "is-blocking-tweets-that-criticize-how-the-2-2255-1619394031-12_dblbig.jpg (image)": 2
            }
        }
        ...
        self.text_json_0 = {
            ...
            "Link": "https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-inequality-developing-world",
            "Summary": "Mexico says it's wrong for wealthy countries to buy up more vaccines than they need, while "
                       "others still don’t have access to a single dose. [image [2] ] [link [1] View Entire Post ›]",
            "Links": {
                "https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-inequality-developing-"
                "world (link)": 1,
                "https://img.buzzfeed.com/buzzfeed-static/static/2020-12/22/18/tmp/20f9b6998076/tmp-name-2-10554-"
        ...
        self.text_json_1 = {
            ...
            "Link": "https://www.buzzfeednews.com/article/janelytvynenko/myanmar-coup-dance",
            "Summary": "The viral video looked too absurd to be real, but online sleuths were able to quickly verify "
                       "its location. [image [2] ] [link [1] View Entire Post ›]",
            "Links": {
                "https://www.buzzfeednews.com/article/janelytvynenko/myanmar-coup-dance (link)": 1,
                "https://img.buzzfeed.com/buzzfeed-static/static/2021-02/1/21/campaign_images/f55df834b2b0/"
                "a-pe-teacher-danced-through-the-coup-in-myanmar-2-8021-1612215221-9_dblbig.jpg (image)": 2
            }
        }
        self.text_json_2 = {
            "Feed": "BuzzFeed News",
    ...
    def test_dump_json(self, stdout):
        ...
        expected_output = ("{\n"
                           "  \"Feed\": \"BuzzFeed News\",\n"
                           "  \"Title\": \"There Is Anger And Resignation In The Developing World As Rich Countries "
                           "Buy Up All The COVID Vaccines\",\n"
                           "  \"Date\": \"Wed, 30 Dec 2020 17:25:39 +0300\",\n"
                           "  \"Link\": \"https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-"
                           "inequality-developing-world\",\n"
                           "  \"Summary\": \"Mexico says it's wrong for wealthy countries to buy up more vaccines "
                           "than they need, while others still don’t have access to a single dose. [image [2] ] "
                           "[link [1] View Entire Post ›]\",\n"
                           "  \"Links\": {\n"
                           "    \"https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-inequality-"
                           "developing-world (link)\": 1,\n"
                           "    \"https://img.buzzfeed.com/buzzfeed-static/static/2020-12/22/18/tmp/20f9b6998076/"
                           "tmp-name-2-10554-1608662537-20_dblbig.jpg (image)\": 2\n"
                           "  }\n"
                           "}\n")
    ...
    def test_print_json(self, stdout):
        ...
        expected_output = ("--------------------------------------------------------------------------------\n"
                           "Feed: BuzzFeed News\n"
                           "Title: There Is Anger And Resignation In The Developing World As Rich Countries Buy Up "
                           "All The COVID Vaccines\n"
                           "Date: Wed, 30 Dec 2020 17:25:39 +0300\n"
                           "Link: https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-inequality-"
                           "developing-world\n"
                           "\n"
                           "Summary: Mexico says it's wrong for wealthy countries to buy up more vaccines than they "
                           "need, while others still don’t have access to a single dose. [image [2] ] [link [1] "
                           "View Entire Post ›]\n"
                           "\n"
                           "Links:\n"
                           "[1] https://www.buzzfeednews.com/article/karlazabludovsky/mexico-vaccine-inequality-"
                           "developing-world (link)\n"
                           "[2] https://img.buzzfeed.com/buzzfeed-static/static/2020-12/22/18/tmp/20f9b6998076/"
                           "tmp-name-2-10554-1608662537-20_dblbig.jpg (image)\n")
